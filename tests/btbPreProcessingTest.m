classdef btbPreProcessingTest < matlab.unittest.TestCase
    %btbPreProcessingTest Regression tests for CO2 startup cleanup.
    ...
    methods (Test)
        ...
        function canKeepCbvInCmPerSec(testCase)
            ...
            result = btbPreProcessing(signalData, 4, settings);
