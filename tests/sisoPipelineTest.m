classdef sisoPipelineTest < matlab.unittest.TestCase
    % sisoPipelineTest Tests the results-only SISO analysis interface.
    ...
    methods (Test)
        ...
        function limitsEveryNestedFrequencyArray(testCase)
            ...
            results = limitSisoResultsToFrequencyRange( ...
                fullResults, [0, 0.35]);
