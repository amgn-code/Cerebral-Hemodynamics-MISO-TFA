...
% createGroupModelResults Collect one group's subject arrays and summaries.
    ...
    if modelName == "miso"
        ...
        normalizedConditionNumber = NaN( ...
            numFrequencies, numIncludedSubjects);
        normalizedDeterminant = NaN( ...
            numFrequencies, numIncludedSubjects);
        minimumNormalizedEigenvalue = NaN( ...
            numFrequencies, numIncludedSubjects);
        reciprocalConditionEstimate = NaN( ...
            numFrequencies, numIncludedSubjects);
        isPoorlyConditioned = false( ...
            numFrequencies, numIncludedSubjects);
    else
    ...
    for subjectIndex = 1:numIncludedSubjects
        ...
        if modelName == "miso"
            ...
            if isfield( ...
                ...
                normalizedConditionNumber(:,subjectIndex) = ...
                    results.diagnostics.normalizedConditionNumber(:);
                normalizedDeterminant(:,subjectIndex) = ...
                    results.diagnostics.normalizedDeterminant(:);
                minimumNormalizedEigenvalue(:,subjectIndex) = ...
                    results.diagnostics.minimumNormalizedEigenvalue(:);
                reciprocalConditionEstimate(:,subjectIndex) = ...
                    results.diagnostics.reciprocalConditionEstimate(:);
                isPoorlyConditioned(:,subjectIndex) = ...
    ...
    if modelName == "miso"
        ...
        groupModelResults.diagnostics.normalizedConditionNumber = ...
            summarizeGroupValues(normalizedConditionNumber);
        groupModelResults.diagnostics.normalizedDeterminant = ...
            summarizeGroupValues(normalizedDeterminant);
        groupModelResults.diagnostics.minimumNormalizedEigenvalue = ...
            summarizeGroupValues(minimumNormalizedEigenvalue);
        groupModelResults.diagnostics.reciprocalConditionEstimate = ...
            summarizeGroupValues(reciprocalConditionEstimate);
        groupModelResults.diagnostics.isPoorlyConditioned = ...
            summarizeGroupValues(double(isPoorlyConditioned));
    else
